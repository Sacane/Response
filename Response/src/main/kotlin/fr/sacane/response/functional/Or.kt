...
infix fun <E> Response<E>.or(response: Response<E>): Response<E> = when(this.status) {
    is Ok -> this
...
infix fun <E> Response<E>.orElse(defaultValue: E): E = if(this.value == null) defaultValue else value
